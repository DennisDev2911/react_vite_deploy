  ...
  return (
    <section className="bg-black py-20 px-6" id="design">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-3xl p-12 mb-16" alt="performance">
          ...
          <ul className="space-y-3 text-gray-300">
            ...
            <li>Neural Engine com 16 nùcleos</li>
            <li>Ray tracing acelerado por harware</li>
          </ul>
        </div>
        ...
        <div id="camera" className="text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-all duration-300 hover:bg-gray-800 cursor-pointer">
